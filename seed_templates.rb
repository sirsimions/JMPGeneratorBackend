...
# Loop through the templates and find or create records
templates_to_seed.each do |template_params|
  ...
  if existing_template
    # Template already exists, update attributes if needed
    existing_template.update(template_params)
    puts "Updated template: #{template_params}"
  else
    # Template does not exist, create a new one
    new_template = Finaltable.create(template_params)
